        ...
        [
            ...
            'sub_menu' => [
                [
                    ...
                    'url' => '/admin/master-data/tahun',
                    'title' => '<i class="fa fa-ellipsis-h"></i>&nbsp;Tahun'
                ], [
                    'url' => '/admin/master-data/slider',
                    'title' => '<i class="fa fa-ellipsis-h"></i>&nbsp;Slider'
                ], [
