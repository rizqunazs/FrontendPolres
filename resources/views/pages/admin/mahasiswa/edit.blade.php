...
<form name="form-skck" action="{{ isset($data) ? route('admin.mahasiswa.update', $data->mahasiswa) : route('admin.mahasiswa.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    @if(isset($data))
    {{ method_field('PUT') }}
    @endif
                        ...
                        <div class="col-md-12">
                            <div class="row ">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="date" id name="tanggal" class="form-control" placeholder="Nama Lengkap"  required />
                                    </div>
                                </div>
                                <div class="col-md-6">
